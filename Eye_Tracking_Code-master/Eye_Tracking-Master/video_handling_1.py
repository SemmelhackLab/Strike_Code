...
class Video(object): #Q why inherit object?
    ...
    def __init__(self, filepath, background=False):
        ...
        self.framecount = int(self.object.get(cv2.CAP_PROP_FRAME_COUNT))     #Number of frames in the video file
    ...
    def grabFrame(self):
        self.object.set(cv2.CAP_PROP_POS_FRAMES, self.framenumber)  # 0-based index of the frame to be decoded/captured next
